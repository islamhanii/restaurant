...
<div class="col-md-6 grid-margin stretch-card">
    <div class="card">
    <div class="card-body">
        <h4 class="card-title">Update <a href="{{url("/dishes/show/$dish->id")}}" class="text-decoration-none"><span class="text-primary">{{$dish->name}}</span></a> Dish</h4>
        <form class="forms-sample" method="POST" action="{{url("/dishes/update")}}" enctype="multipart/form-data">
